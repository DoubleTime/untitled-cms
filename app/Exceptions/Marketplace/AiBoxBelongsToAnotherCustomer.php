...
/**
 * An AI Box is identified by the motherboard UUID it reports, and it belongs to
 ...
 */
class AiBoxBelongsToAnotherCustomer extends RuntimeException
{
    public static function for(string $motherboardUuid): self
    {
        return new self(
            "This AI Box (motherboard UUID {$motherboardUuid}) is already registered to a different Customer. "
