...
/**
 * Derives what an AI Box currently has installed.
 *
 ...
 * log — bounded by one AI Box, so tens to a few hundred rows — ordered newest
...
class AiBoxInstalledService
{
     ...
     */
    public function forBox(AiBox $box): array
    {
        $downloads = Download::query()
            ->where('ai_box_id', $box->getKey())
     ...
     * @return array<string, FlowchartScript|AiModel>
     */
    ...
    /**
     * @return class-string<FlowchartScript>|class-string<AiModel>|null
     */
