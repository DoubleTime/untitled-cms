...
/**
 * Preview Images are ordinary public Vault pictures attached to a FlowChart
 * Script in display order; the first is the cover.
 */
class FlowchartScriptImagesTest extends TestCase
{
    use RefreshDatabase;

    protected User $admin;

    protected FlowchartScript $script;
    ...
    protected function setUp(): void
    {
        ...
        $this->script = FlowchartScript::factory()->create();
    }
    ...
    public function test_syncing_replaces_the_previous_list_and_can_reorder(): void
    {
        ...
        FlowchartScriptImage::create([
            'flowchart_script_id' => $this->script->id,
